...
const Leading = () => {
    return (
        <div className="bg-[#F4F3F0] pl-16">
            <h6 className="font-bold text-[#09b850] pt-10">WE ARE SUGGESTIFY</h6>
            <h4 className="py-3 text-3xl font-bold">Leading products & online suggestion store in Bangladesh</h4>
